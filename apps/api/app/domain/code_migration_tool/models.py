...
class AgenticCodeMigrationToolSession(Base):
    __tablename__ = "code_migration_tool_sessions"
...
class AgenticCodeMigrationToolItem(Base):
    __tablename__ = "code_migration_tool_items"

    id = Column(String, primary_key=True, index=True)
    session_id = Column(String, ForeignKey("code_migration_tool_sessions.id"))
